...
module.exports = {
    ...
    'ci:mv:windows': () => `mv cloudcmd-win32-x64 cloudcmd-v${version}-win32-x64`,
    'zip:windows': () => `onezip -p cloudcmd-v${version}-win32-x64`,
    'ci:zip:windows': () => `onezip -p cloudcmd-v${version}-win32-x64`,
    ...
    'ci:upload:windows': () => `putasset -l -o coderaiser -r cloudcmd -t v${version} -f cloudcmd-v${version}-win32-x64.zip`,
